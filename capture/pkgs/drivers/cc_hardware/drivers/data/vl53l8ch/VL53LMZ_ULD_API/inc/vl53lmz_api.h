 ...
 * VL53LMZ_Configuration.module_type field
 */

#define VL53LMZ_MODULE_TYPE_L5			((uint8_t) 0U)
#define VL53LMZ_MODULE_TYPE_L7			((uint8_t) 1U)
...
/**
 * @brief The default power mode is VL53LMZ_POWER_MODE_WAKEUP. User can choose two
 * different modes to save power consumption when is the device
 * is not used:
 * - VL53LMZ_POWER_MODE_SLEEP: This mode retains the firmware and the configuration. It
...
#define VL53LMZ_POWER_MODE_DEEP_SLEEP	((uint8_t) 2U)
 ...
 * limited to 32 so that only the first word of of the output_enables needs
 * to be updated.
 */

#define NUM_OUTPUT_ENABLE_WORDS	        4U
#define NUM_OUTPUT_CONFIG_WORDS	        32U
...
#define LMZ_AMB_SIZE	260U
#else
#define LMZ_AMB_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_NB_SPADS_ENABLED
#define LMZ_SPAD_SIZE	260U
#else
#define LMZ_SPAD_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_NB_TARGET_DETECTED
#define LMZ_NTAR_SIZE	68U
#else
#define LMZ_NTAR_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_SIGNAL_PER_SPAD
#define LMZ_SPS_SIZE ((256U * VL53LMZ_NB_TARGET_PER_ZONE) + 4U)
#else
#define LMZ_SPS_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_RANGE_SIGMA_MM
#define LMZ_SIGR_SIZE ((128U * VL53LMZ_NB_TARGET_PER_ZONE) + 4U)
#else
#define LMZ_SIGR_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_DISTANCE_MM
#define LMZ_DIST_SIZE ((128U * VL53LMZ_NB_TARGET_PER_ZONE) + 4U)
#else
#define LMZ_DIST_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_REFLECTANCE_PERCENT
#define LMZ_RFLEST_SIZE ((64U * VL53LMZ_NB_TARGET_PER_ZONE) + 4U)
#else
#define LMZ_RFLEST_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_TARGET_STATUS
#define LMZ_STA_SIZE ((64U	* VL53LMZ_NB_TARGET_PER_ZONE) + 4U)
#else
#define LMZ_STA_SIZE	0U
#endif

#ifndef VL53LMZ_DISABLE_MOTION_INDICATOR
#define LMZ_MOT_SIZE	144U
#else
#define LMZ_MOT_SIZE	0U
#endif
 ...
 * VL53LMZ. If user wants more than 1 target per zone, the results can be split
 * into 2 sub-groups :
 ...
 * be called after a power on, to load the firmware into the VL53LMZ. It takes
 ...
 * (VL53LMZ_POWER_MODE_SLEEP), 1 if sensor is in standard mode
 * (VL53LMZ_POWER_MODE_WAKEUP), or 2 if the sensor is in ultra low power
 ...
 * or VL53LMZ_POWER_MODE_WAKEUP or VL53LMZ_POWER_MODE_DEEP_SLEEP)
